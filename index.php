...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="51">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light fixed-top shadow py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="./" class="navbar-brand d-block d-lg-none">
            <h1 class="text-primary fw-bold m-0">Restu</h1>
        </a>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6 py-6 pb-0 pt-lg-0">
                    ...
                    <h2 class="display-5 mb-3">Restu Fatwian, S.Kom</h2>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="d-flex align-items-center mb-5">
                        <h3 class="lh-base mb-0">I'm Restu, a young designer & web development based in Bogor</h3>
                    </div>
                    <p class="mb-4">Hi there!... I was born and raised in Bogor. My main expertise lies in graphic design, though I do often make UI/UX design and web development. If you like my site, don’t hesitate to reach out! </p>
                    <p class="mb-3"><i class="far fa-check-circle text-primary me-3"></i>Web Developer  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <i class="far fa-check-circle text-primary me-3"></i>UI/UX Designer  &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <i class="far fa-check-circle text-primary me-3"></i>Graphic Designer</p>
                </div>
                <div class="col-lg-2 wow fadeInUp" data-wow-delay="0.5s"></div>
            </div>
        </div>
    </div>
    <!-- About End -->
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-4">With experience, I have worked well and consistently delivering impactful and creative solutions.</p>
                    <h3 class="mb-4">My Skills</h3>
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <div class="skill mb-4">
                                <div class="d-flex justify-content-between">
                                    <h6 class="font-weight-bold">Graphic Design</h6>
                                </div>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            <div class="row gy-5 gx-4">
                                <div class="col-sm-6">
                                    ...
                                    <p class="text-primary mb-1">2013 - 2016</p>
                                    <h6 class="mb-0">SMK Negeri 1 Bojonggede</h6>
                                </div>
                                <div class="col-sm-6">
                                    <h5>Computer Science</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">2017 - 2022</p>
                                    <h6 class="mb-0">Universitas Pakuan</h6>
                                </div>
                            </div>
                        </div>
                        <div id="tab-2" class="tab-pane fade show p-0">
                            <div class="row gy-5 gx-4">
                                ...
                                <div class="col-sm-6">
                                    <h5> Junior Web Development</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">2021</p>
                                    <h6 class="mb-0">Lembaga Sertifikasi Profesi</h6>
                                </div>
                                <div class="col-sm-6">
                                    <h5>Junior Graphic Design</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">2020</p>
                                    <h6 class="mb-0">BPPTIK</h6>
                                </div>
                                <div class="col-sm-6">
                                    <h5>Junior Web Programming</h5>
                                    <hr class="text-primary my-2">
                                    <p class="text-primary mb-1">2015</p>
                                    <h6 class="mb-0">PT Quantum Business Int.</h6>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row g-5 mb-5 align-items-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="col-lg-6 text-lg-end">
                    <ul class="list-inline mx-n3 mb-0" id="portfolio-flters">
                        ...
                        <li class="mx-3" data-filter=".first">Graphic Design</li>
        ...
        <div class="container py-5">
            ...
            <div class="row g-5">
                <div class="col-lg-7 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <h3 class="fw-bold">Kp. Duren baru Poncol, Bojonggede, Bogor </h3>
                    <hr class="w-100">
                    <p class="mb-2">Call me:</p>
                    <h3 class="fw-bold"><a href="https://t.me/mochii_rf" target="_blank">+62 896 7333 8894</a></h3>
                    <hr class="w-100">
                    <p class="mb-2">Mail me:</p>
                    <h3 class="fw-bold"><a href="mailto:restu.fatwian@gmail.com?subject=Hey there!">restu.fatwian165@gmail.com</a></h3>
                    <h3 class="fw-bold"><a href="mailto:cece.restu@gmail.com?subject=Hey there!">cece.restu@gmail.com</a></h3>
                    <hr class="w-100">
    ...
    <div class="container-xxl pt-5 px-0 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container-xxl pt-5 px-0">
            <div class="bg-dark">
                <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d31715.30916556429!2d106.77417534213839!3d-6.469170557907997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69c27482040375%3A0xbf87602aba575532!2sSusukan%2C%20Bojonggede%2C%20Bogor%20Regency%2C%20West%20Java%2C%20Indonesia!5e0!3m2!1sen!2sbd!4v1662538217497!5m2!1sen!2sbd"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <script>document.write(new Date().getFullYear());</script> Restu Fatwian, All Right Reserved.
                    </div>
